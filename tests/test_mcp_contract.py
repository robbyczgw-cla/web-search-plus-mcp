...
def test_wheel_config_includes_v4_contracts_and_migration_guide():
    ...
    assert forced["docs/RELEASE_4_2_0.md"] == "web_search_plus_mcp/docs/RELEASE_4_2_0.md"
    assert forced["docs/RELEASE_4_2_1.md"] == "web_search_plus_mcp/docs/RELEASE_4_2_1.md"
    ...
    assert forced["docs/RELEASE_3_3.md"] == (
        "web_search_plus_mcp/docs/RELEASE_3_3.md"
    )
...
def test_readme_describes_current_source_only_release_surface():
    ...
    assert "`web-search-plus-mcp 4.3.1`" in readme
    ...
    assert "Hermes-plugin-only" in release or "Hermes plugin" in release
    assert "LugMuad" in readme and "LugMuad" in release
    assert "hermes-web-search-plus/issues/125" in readme
    assert "hermes-web-search-plus/issues/125" in release
    assert "dondai44423/donsetch" in release
