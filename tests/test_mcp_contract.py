...
def test_readme_describes_current_source_only_release_surface():
    readme = (ROOT / "README.md").read_text()
    assert "`web-search-plus-mcp 4.0.4`" in readme
    assert "DonSeTch 3.2.1" in readme
